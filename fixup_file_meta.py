...
#    '0/01/Starfire_2.1_retro.vmod': (2, 1, 0, retro, None),
#    '0/01/TLD-v0.8b081c-3-28-21.vmod': (0, 8, 0, b081c, None),
#    '0/03/Flying_Colors_vol4_1-0-2.vmdx': (4, 1, 0, 2, None),
#    '0/04/Pacific_Victory_v2.0f.vmod': (2, 0, 0, 'f', None),
#    '0/04/TLD-v0.3p21.vmod': (0, 3, 0, p21, None),
#    '0/09/AfrikaKorps-2.0-ch-oldschool.vmod': (1, 1, 0, OS, None),
    '0/09/Aww-v10.vmod': (1, 0, 0, None, None),
#    '1/10/Bobby_Lee-v6b.vmod': (6, 0, 0, b, None),
#    '1/10/Paths_of_Glory_7f.vmod': (7, 0, 0, f, None),
...
#    '1/14/Luna_Mare_Dominatio_20220126_v1.vmod': (20220126, 0, 0, v1, None),
#    '1/14/Marine_Fighter_Squadron_1_1alt.vmod': (1, 1, 0, alt, None),
#    '1/18/Bayonets_N_Tomahawks_1.0.vmod': (24, 0, 0, , None),
#    '1/18/Napoleons_Triumph_v0.84-no-teams.vmod': (0, 84, 0, noteams, None),
    '1/19/CasaFantasmas.vmod': (1, 0, 0, None, None),
#    '1/19/Kremlin_v3.1.vmod': (3, 1, 0, AdvancedRules, None),
#    '1/1b/Bobby_Lee-vX5.vmod': (5, 0, 0, , None),
    '1/1b/TheOtherSide1.1.vmod': (1, 1, 0, None, None),
#    '1/1c/PW2_v101.vmod': (2, 1, 0, , None),
#    '1/1d/Battlelore.mod.vmod': (1, 0, 0, c, None),
...
#    '1/1f/TLD-v0.8b080a-9-30-20.vmod': (0, 8, 0, b080a, None),
#    '2/20/Combat_3_1.vmod': (3, 1, 0, 2ndPrintArt, None),
...
#    '2/22/Tokyo_express_v.097.vmod': (0, 97, 0, Beta, None),
...
#    '2/29/Smolensk_1_20EF.vmod': (1, 20, 0, EF, None),
#    '2/2a/Vietnam4_2h.vmod': (4, 2, 0, h, None),
#    '2/2b/Battlefleet_Mars_V2.0.vmod': (0, 2, 0, K27, None),
    '2/2c/Silent_War.vmod': (0, 97, 0, None, None),
    '2/2d/Devils2PayR3a.vmod': (3, 0, 0, 'a', None),
#    '2/2f/Reluctant_Enemies_1_16EF.vmod': (1, 16, 0, EF, None),
...
#    '3/34/TLD-v0.8b080d-11-16-20.vmod': (0, 8, 0, b080d, None),
    '3/34/VIPv34p01.vmod': (3, 4, 0, 'p01', None),
#    '3/34/WHDW_2X43.vmod': (2, 0, 0, X43, None),
...
#    '4/43/Luna_Mare_Mineralis_20210108_v1.vmod': (20210108, 0, 0, v1, None),
...
#    '4/4d/Smolensk_1_21EF.vmod': (1, 21, 0, EF, None),
#    '4/4d/TLD-v0.8b080F-2-26-21.vmod': (0, 8, 0, b080F, None),
#    '4/4e/Luna_Mare_Mineralis_20220126_v1.vmod': (20220126, 0, 0, v1, None),
...
#    '5/54/Luna_Mare_Mineralis_20201120_v1.vmod': (20201120, 0, 0, v1, None),
...
#    '5/5f/WHDW_2X44.vmod': (2, 0, 0, X44, None),
...
#    '6/66/TLD-v0.8b080e-12-20-20.vmod': (0, 8, 0, b080e, None),
...
#    '6/6d/TLD-v0.5b33.vmod': (0, 5, 0, b33, None),
...
#    'a/a4/Luna_Mare_Mineralis_20210312_v1.vmod': (20210312, 0, 0, v1, None),
#    'a/a4/TI3_LIVE_v1_00SE.vmod': (1, 0, 0, SE, None),
#    'a/a5/TLD-v0.7b08.vmod': (0, 7, 0, b08, None),
#    'a/aa/Crusader_Kingdoms1.0.vmod': (0, 0, 0, X, None),
    'a/aa/TheOtherSide1.2.vmod': (1, 2, 0, None, None),
#    'a/aa/TLD-v0.8b083e-11-28-21.vmod': (0, 8, 0, b083e, None),
...
#    'a/ad/TLD-v0.4b20.vmod': (0, 4, 0, b20, None),
...
#    'c/c2/TLD-v0.8b081b-3-27-21.vmod': (0, 8, 0, b081b, None),
...
#    'c/c8/TLD-v0.6b09.vmod': (0, 6, 0, b09, None),
...
#    'c/cb/Tokyo_express.vmod': (0, 9, 0, Beta, None),
#    'c/cf/TLD-v0.8b079-200606-0950.vmod': (0, 8, 0, b079, None),
...
#    'd/d6/Reluctant_Enemies_1_15EF.vmod': (1, 15, 0, EF, None),
    'd/d8/Labyrinth_v5.vmod': (5, 0, 0, None, None),
#    'd/d8/TLD-v0.8b082-4-15-21.vmod': (0, 8, 0, b082, None),
    'd/d9/Labyrinth_v5-1.vmod': (5, 1, 0, None, None),
#    'd/d9/Luna_Mare_Dominatio_20210312_v1.vmod': (20210312, 0, 0, v1, None),
